      ...
      return _regenerator["default"].wrap(function (_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 1:
            ...
            userId = user.user_id;
            _context.next = 2;
            return _database["default"].query("UPDATE listings \n            SET name = ?, description = ?, price = ?\n            WHERE id = ? AND user_id = ?", [name, description, price, id, userId]);
          case 2:
            _context.next = 3;
            return _database["default"].query('SELECT * FROM listings WHERE id =? AND user_id = ?', [id, userId]);
          case 3:
